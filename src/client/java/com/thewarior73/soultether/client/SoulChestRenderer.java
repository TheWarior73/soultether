...
public class SoulChestRenderer implements BlockEntityRenderer<SoulChestBlockEntity, SoulChestRenderState> {
    ...
    private static final SpriteId SPRITE_ID = new SpriteId(TextureAtlas.LOCATION_BLOCKS, Identifier.fromNamespaceAndPath("soultether", "entity/chest/soul_chest"));
    ...
    @Override
    public void extractRenderState(SoulChestBlockEntity entity, SoulChestRenderState state, float tickDelta, Vec3 pos, CrumblingOverlay breakProgress) {
    ...
    @Override
    public void submit(SoulChestRenderState state, PoseStack poseStack, SubmitNodeCollector collector, CameraRenderState camera) {
        poseStack.pushPose();
